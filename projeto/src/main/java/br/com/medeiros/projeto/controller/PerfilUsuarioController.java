package br.com.medeiros.projeto.controller;
...
import br.com.medeiros.projeto.service.PerfilService;
import br.com.medeiros.projeto.service.PerfilUsuarioService;
...
public class PerfilUsuarioController {
	...
	public void inserir(@RequestBody PerfilUsuarioDTO perfil) {
		perfilUsuarioService.inserir(perfil);
	}
	
	@PutMapping
	public PerfilUsuarioDTO alterar(@RequestBody PerfilUsuarioDTO perfil) {
		return perfilUsuarioService.alterar(perfil);
	}
